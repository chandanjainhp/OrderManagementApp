...
export const ORDER_UPDATE_TEMPLATE = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Your Order Update - Order Management App</title>
</head>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #1f2937; max-width: 600px; margin: 0 auto; padding: 0; background: linear-gradient(135deg, #f3f4f6 0%, #f9fafb 100%);">
  <div style="padding: 40px 20px 0;">
    <!-- Header -->
    <div style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); padding: 40px 30px; text-align: center; border-radius: 12px 12px 0 0; box-shadow: 0 10px 30px rgba(59, 130, 246, 0.2);">
      <div style="display: inline-block; background: rgba(255,255,255,0.1); padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; font-size: 24px;">📦</div>
      <h1 style="color: #ffffff; margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -0.5px;">Order Management App</h1>
      <p style="color: rgba(255,255,255,0.9); margin: 8px 0 0; font-size: 14px; font-weight: 500;">Order Status Update</p>
    </div>

    <!-- Content -->
    <div style="background-color: #ffffff; padding: 40px 30px; border-radius: 0 0 12px 12px;">
      <p style="font-size: 16px; color: #374151; margin: 0 0 20px; font-weight: 500;">Hi {customerName},</p>
      <p style="font-size: 15px; color: #6b7280; margin: 0 0 30px; line-height: 1.8;">We're reaching out to provide an update on your recent order. Please see the details below.</p>

      <!-- Order Details Box -->
      <div style="background: #f8fafc; border: 1px solid #e2e8f0; padding: 25px; border-radius: 12px; margin: 25px 0;">
        <h2 style="font-size: 18px; color: #0f172a; margin: 0 0 20px; border-bottom: 1px solid #e2e8f0; padding-bottom: 10px;">Order Details</h2>
        
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            <td style="padding: 8px 0; color: #64748b; font-size: 14px; font-weight: 500;">Order ID:</td>
            <td style="padding: 8px 0; color: #0f172a; font-size: 14px; font-weight: 600; text-align: right;">#{orderId}</td>
          </tr>
          <tr>
            <td style="padding: 8px 0; color: #64748b; font-size: 14px; font-weight: 500;">Status:</td>
            <td style="padding: 8px 0; text-align: right;">
              <span style="background-color: #dbeafe; color: #1e40af; padding: 4px 12px; border-radius: 9999px; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
                {orderStatus}
              </span>
            </td>
          </tr>
          <tr>
            <td style="padding: 12px 0 0; color: #64748b; font-size: 15px; font-weight: 600; border-top: 1px dashed #cbd5e1;">Total Amount:</td>
            <td style="padding: 12px 0 0; color: #16a34a; font-size: 18px; font-weight: 700; text-align: right; border-top: 1px dashed #cbd5e1;">₹{totalAmount}</td>
          </tr>
        </table>
      </div>

      <!-- General Info -->
      <p style="font-size: 14px; color: #6b7280; margin: 0 0 20px; line-height: 1.8;">If you have any questions regarding your order, feel free to contact us by replying to this email.</p>

      <p style="font-size: 15px; color: #374151; margin: 30px 0 0;">Thank you for your business!</p>
    </div>

    <!-- Footer -->
    <div style="text-align: center; padding: 30px 20px; color: #9ca3af; font-size: 12px;">
      <p style="margin: 0 0 8px;">Made with ❤️ by <strong style="color: #3b82f6;">Order Management App</strong></p>
      <p style="margin: 0; opacity: 0.7;">© 2026 Order Management App. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
